...
#
# Fixed architecture: 1-way description embedding only.
#
# Notes:
...
OUTPUT_DIR = os.path.join(OUTPUT_ROOT, "CVE_to_CWE", "NN_1way")

DEVICE = "cuda" if torch.cuda.is_available() else "cpu"

print("Device:", DEVICE)
print("Feature mode: desc_only (fixed)")
...
def build_features(split_df, split_name):
    ...
    X = l2_normalize_np(desc_emb).astype(np.float32)
